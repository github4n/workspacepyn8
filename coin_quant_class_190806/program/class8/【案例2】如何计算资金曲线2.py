...
# =====导入数据
df = pd.read_hdf('F:\workspacepyn\coin_quant_class_190806\data\class8\eth_bolling_signal.h5', key='all_data')

# df = df[df['candle_begin_time'] <= "2018/03/01 15:00:00"]
# df = df[df['candle_begin_time'] >= "2018/02/28 15:00:00"]
# print(df)
# exit()
...
init_cash = 100  # 初始资金
c_rate = 2.0 / 1000  # 手续费
min_margin_rate = 0.20  # 最低保证金比例，必须占到借来资产的15%
