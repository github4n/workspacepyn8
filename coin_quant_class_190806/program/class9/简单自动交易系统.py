...
import ccxt
from coin_quant_class_190806.program.class9.Trade import next_run_time, place_order, get_okex_candle_data, auto_send_email
from coin_quant_class_190806.program.class8.Signals import signal_moving_average
